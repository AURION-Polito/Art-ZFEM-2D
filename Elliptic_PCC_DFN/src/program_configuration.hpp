...
struct Program_configuration final
{
    Program_configuration()
    {
        ...
        Gedim::Configurations::AddProperty("GeometricTolerance1D", 1.0e-6, "Geometric Tolerance 1D (Default: 1.0e-6)");

        Gedim::Configurations::AddProperty("GeometricTolerance2D", 1.0e-12, "Geometric Tolerance 2D (Default: 1.0e-12)");
        ...
        Gedim::Configurations::AddProperty("MethodType",
                                           ...
                                           "Method Type, 0 - FEM; 1 - EVem; 2 - EVem_Inertia; 3 - EVem_Ortho; 4 - ZFEM "
                                           "(Default: "
                                           "0)");
