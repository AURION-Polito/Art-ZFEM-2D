...
namespace Polydim
{
  namespace examples
  {
    namespace Elliptic_Extended_PCC_2D
    {
      ...
      {
        // ***************************************************************************
        std::unique_ptr<Polydim::examples::Elliptic_Extended_PCC_2D::test::I_Test> create_test(const Polydim::examples::Elliptic_Extended_PCC_2D::Program_configuration &config)
        {
          switch (config.TestType())
          {
            ...
            case Polydim::examples::Elliptic_Extended_PCC_2D::test::Test_Types::Elliptic_Problem:
              return std::make_unique<Polydim::examples::Elliptic_Extended_PCC_2D::test::Elliptic_Problem>(config.GeometricTolerance1D(),
                                                                                                           config.GeometricTolerance2D(),
                                                                                                           1);
            case Polydim::examples::Elliptic_Extended_PCC_2D::test::Test_Types::Patch_Test_Rotated:
              return std::make_unique<Polydim::examples::Elliptic_Extended_PCC_2D::test::Patch_Test_Rotated>(config.GeometricTolerance1D(),
                                                                                                             config.GeometricTolerance2D(),
                                                                                                             config.MethodOrder());
        ...
        // ***************************************************************************
        PDETools::Mesh::PDE_Mesh_Utilities::Extended_MeshGeometricData2D create_domain_mesh_geometric_properties(const Polydim::examples::Elliptic_Extended_PCC_2D::Program_configuration &config,
                                                                                                                 const PDETools::Mesh::PDE_Mesh_Utilities::PDE_Domain_2D_Collection &domains,
                                                                                                                 const Gedim::MeshMatricesDAO &mesh)
        {
          ...
          if (domains.domains_2D.size() == 1)
          {
            ...
            mesh_geometric_data.mesh_geometric_data = Polydim::PDETools::Mesh::PDE_Mesh_Utilities::compute_mesh_2D_geometry_data(geometryUtilities,
                                                                                                                                 meshUtilities,
                                                                                                                                 mesh_2D);
          ...
          else
          {
            switch (config.MeshGenerator())
            {
              ...
              case Polydim::PDETools::Mesh::PDE_Mesh_Utilities::MeshGenerator_Types_2D::OFFImporter:
              {
                mesh_geometric_data.mesh_geometric_data = meshUtilities.ImportMeshGeometricData2DFromTxt(config.MeshImportFilePath() + "/geometric_data.txt");
                            ...
                            const std::string& export_folder)
        {
...

          {
            ...
            for (unsigned int d = 0; d < domains.domains_2D.size(); ++d)
            {
              ...
              vtkUtilities.AddPolygon(domain_vertices,
                                      {
                                        {
                                          "domain_position",
                                          Gedim::VTPProperty::Formats::Cells,
