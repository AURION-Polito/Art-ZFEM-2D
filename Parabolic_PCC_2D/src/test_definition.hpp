...
{
    Patch_Test = 1,
    Convergence_in_space = 2,
    Convergence_in_time = 3,
...
// ***************************************************************************
struct Convergence_in_space final : public I_Test
{
    static unsigned int time_order;
    ...
    Eigen::VectorXd source_term(const unsigned int region_id, const Eigen::MatrixXd &points, const double &time_value) const
    {
        Eigen::ArrayXd source_term = 2.0 * std::numbers::pi * std::numbers::pi * sin(std::numbers::pi * points.row(0).array()) *
    ...
    Eigen::VectorXd exact_solution(const Eigen::MatrixXd &points, const double &time_value) const
    {
        Eigen::ArrayXd result = sin(std::numbers::pi * points.row(0).array()) * sin(std::numbers::pi * points.row(1).array());
...
// ***************************************************************************
struct Convergence_in_time final : public I_Test
{
    static unsigned int space_order;
    ...
    Eigen::VectorXd source_term(const unsigned int region_id, const Eigen::MatrixXd &points, const double &time_value) const
    {
        ...
        source_term -= 2.0 * exp(2.0 * time_value);
